...
function az_load_dev_styles_scripts() {
  ...
  // Footer Scripts
  wp_enqueue_script( 'main', SS_URI . '/assets/dist/js/app.js', array( 'jquery' ), null, true );
}

if ( 'local' == WP_ENV ) add_action( 'wp_enqueue_scripts', 'az_load_dev_styles_scripts' );
...
function az_load_prod_styles_scripts() {
  ...
  // Footer Scripts
  wp_enqueue_script( 'main', SS_URI . '/assets/dist/js/app.min.js', array( 'jquery' ), null, true );
}
if ( 'local' != WP_ENV ) add_action( 'wp_enqueue_scripts', 'az_load_prod_styles_scripts' );
